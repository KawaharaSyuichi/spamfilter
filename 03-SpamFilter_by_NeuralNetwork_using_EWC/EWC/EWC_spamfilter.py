...
model_path = "/Users/kawahara/Documents/10-maildata/01-spam/doc2vec_models/"
...
May_ham_model_doc2vec = Doc2Vec.load(model_path + "ham_doc2vec_of_May.model")
...
train_task(model, 320, 20, March_mail_list, [
