...
class Model:
    def __init__(self, x, y_):
        ...
        h9 = tf.nn.relu(tf.matmul(h8, W9) + b9)
        h10 = tf.nn.relu(tf.matmul(h9, W10) + b10)

        W_last = weight_variable([100, out_dim])
        b_last = bias_variable([out_dim])

        self.y = tf.matmul(h10, W_last) + b_last  # output layer

        self.var_list = [W1, b1, W2, b2, W3,
                         b3, W4, b4, W5, b5,
                         W6, b6, W7, b7, W8,
                         b8, W9, b9, W10, b10,
                         W_last, b_last]
